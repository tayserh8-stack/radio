...
const Navbar = ({ user, onLogout, onToggleSidebar }) => {
  ...
  const getRoleLabel = () => {
    ...
    if (user.role === 'manager') return `مدير ${getDepartmentName(user.department)}`;
    return 'موظف';
  };
    ...
    <nav className="bg-white shadow-md px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={notificationRef}>
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl z-50 animate-fade-in dropdown-menu">
...
<div className="relative" ref={userMenuRef}>
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 animate-fade-in dropdown-menu">
